...
**Question 3.3**: What do you think the purpose of including the variable `rgdp60` is? Look at `?GrowthSW` to find out what the variables mean. 
  ...
  Above, we find depicted a linear model with the dependent variable being  "growth, whereas the independent variables are: "treat", "rgdp60","tradeshare" and education. By including "rgdp60" as one of the independent variables in the model, our aim is to control for the influence of the initial economic conditions on the growth rate (growth) being studied. Linear models in general do not provide us with certain results, however it helps us determine the effects of the independent variables on the dependent variable. Given that all the other variables are held constant, a change of one unit in "rgdp60" will lead, on average, to a β2 change in growth.
